#! python3
# fundingData.py - Scrapes funding news from various data sources, aggregates on website ad notifies user based on their region
...
def update_google_sheets(data):
    ...
    for entry in data:
        if entry['headline'] not in existing_headlines:
            sheet.appendRow([entry['headline'], entry['link'], entry['date']])
